				...
				<div class="col-md-12">
					...
					<div class="portlet">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i>ตรวจสอบห้องประชุม
							</div>
							<div class="tools">
							...
							<form action="#" class="form-horizontal form-bordered">
								<div class="form-body">
									<div class="form-group">
										<label class="control-label col-md-3">เช็คห้องว่าง</label>
										<div class="col-md-4">
											...
											<br ><button type="submit" class="btn btn-success"><i class="fa fa-check"></i> ตรวจสอบ</button>
											
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-3">เลือกวันที่</label>
										<div class="col-md-3">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="col-md-offset-3 col-md-9">
												<button type="submit" class="btn btn-success"><i class="fa fa-check"></i> ตรวจสอบเวลา</button>

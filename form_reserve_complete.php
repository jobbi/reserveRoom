							...
							<form action='#' method="" class="form-horizontal form-bordered" >
								<div class="form-body">
									...
									<label class="control-label col-md-3">ชื่อผู้จอง</label>
										<div class="col-md-4">
											<input type="text" class="form-control" maxlength="25" name="nameuser" value="<?= $obj->getnameuser;?> " ?id="maxlength_defaultconfig">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="col-md-offset-3 col-md-9">
												<button type="submit" class="btn btn-info"><i class="fa fa-check"></i> ยืนยัน</button>
												<button type="button" class="btn btn-default"><i class="fa fa-check">แก้ไข</button>
											</div>
										</div>
									</div>
								</div>

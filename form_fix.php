...
<head>
<meta charset="utf-8"/>
<title>Conquer | Form Stuff - Form Layouts</title>
						...
						<div class="tab-content">
								<div class="portlet">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-reorder"></i>ฟอร์มใบแจ้งซ่อม / ร้องเรียน
										</div>
										<div class="tools">
										...
										<div class="col-md-9">
											<input type="time" id="timefix" name="timefix_db"class="form-control" placeholder="">
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-3">ระบุห้องประชุม</label>
															<div class="col-md-9">
												...
												<h3 class="form-section">รายการแจ้งซ่อม</h3>
												<!--/row-->
												<div class="row">
												<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																...
																<option> </option>
																	...
																	<option name="mike">ไมค์โครโฟน</option>
																	<option name="loudspeaker">ลำโพง</option>
																	<option name="table">โต๊ะ</option>
																	<option name="chair">เก้าอี้</option>
																	<option name="air">แอร์</option>
																</select>
															</div>
														</div>
													</div>
													...
													<div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-3">ประเภทอุปกรณ์</label>
															<div class="col-md-9">
																<select name="tool2_db" class="form-control">
																<option> </option>
																	<option name="projector">โปรเจคเตอร์</option>
																	<option name="computer">คอมพิวเตอร์</option>
																	<option name="mike">ไมค์โครโฟน</option>
													...
													<div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-3">รายละเอียดที่ 2</label>
																
															<div class="col-md-9">
														<textarea class="wysihtml5 form-control" name ="description2_db"rows="4"></textarea>
													</div>
												...
												<div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-3">ประเภทอุปกรณ์</label>
															<div class="col-md-9">
																<select name="tool3_db" class="form-control">
																<option> </option>
																	<option name="projector">โปรเจคเตอร์</option>
																	<option name="computer">คอมพิวเตอร์</option>
																	<option name="mike">ไมค์โครโฟน</option>
													...
													<div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-3">รายละเอียดที่ 3</label>
																	
															<div class="col-md-9">
														<textarea class="wysihtml5 form-control" name ="description3_db"rows="4"></textarea>
													</div>
												</div>
													...
													<div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-3">ประเภทอุปกรณ์</label>
															<div class="col-md-9">
																<select name="tool4_db" class="form-control">
																<option> </option>
																	<option name="projector">โปรเจคเตอร์</option>
																	<option name="computer">คอมพิวเตอร์</option>
																	<option name="mike">ไมค์โครโฟน</option>
													...
													<div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-3">รายละเอียดที่ 4</label>	
															<div class="col-md-9">
														<textarea class="wysihtml5 form-control" name ="description4_db" rows="4"></textarea>
													</div>
														</div>
													</div>
													<!--/span-->
												...
												<div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-3">ประเภทอุปกรณ์</label>
															<div class="col-md-9">
																<select name="tool5" class="form-control">
																<option> </option>
																	<option name="projector">โปรเจคเตอร์</option>
																	<option name="computer">คอมพิวเตอร์</option>
																	<option name="mike">ไมค์โครโฟน</option>
													...
													<div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-3">รายละเอียดที่ 5</label>	
															<div class="col-md-9">
														<textarea class="wysihtml5 form-control" name ="description5" rows="4"></textarea>
													</div>
														</div>
													</div>
													<!--/span-->
												...
												<div class="row">
													<div class="col-md-6">
														<div class="col-md-offset-10 col-md-9">
															<button type="submit" name="submit" class="btn btn-success">บันทึก</button>&nbsp

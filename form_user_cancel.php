						...
						<div class="tab-content">
								...
								<div class="portlet">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-reorder"></i>ยกเลิกการจอง
										</div>
										<div class="tools">
										...
										<form action="#" class="form-horizontal">
											<div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-12">
														...
														<center><table cellpadding="0" width="100%" height="5%" border="1">
													  <tr class="success" >
															<th colspan="7" scope="col"><center>แสดงรายการจอง</center></th>
													  </tr>
													  <tr >
														<td class="info" align="center"width="60" height="40">ลำดับที่</td>
														<td class="info" align="center" width="100" height="40" >วันที่</td>
														<td class="info" align="center" width="65" height="40">เวลา</td>
														<td class="info" align="center" width="120" height="40">ห้องประชุม</td>
														<td class="info" align="center" width="150" height="40">หัวข้อประชุม</td>
														<td class="info" align="center" width="65" height="40">สถานะ</td>
														<td class="info" align="center" width="50" height="40">ยกเลิก</td>
														
													  </tr>
														<td align="center" width="60" height="40"></td>
														<td align="center" width="100" height="40"></td>
														<td align="center" width="120" height="40"></td>
														<td align="center" width="65" height="40"></td>
														<td align="center" width="80" height="40"></td>
														<td align="center" width="150" height="40"></td>
														<td align="center" width="50" height="40"> <input type="button"style="width:120px" class="btn btn-danger" value=ยกเลิกการจอง ></td>
													  <tr>
													  </tr>
													</table>
													</center>
											...
											<div class="form-actions fluid">
												<div class="col-md-offset-5 col-md-9">
													<a href="http://localhost:8080/template_content/form_fix.html"><button type="button" class="btn btn-info">แจ้งซ่อม</button></a>&nbsp
													<button type="button" class="btn btn-default">ปิด</button>
												</div>
											</div>
										</form>
										<!-- END FORM-->

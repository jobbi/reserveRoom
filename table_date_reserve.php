						...
						<div class="tab-content">
								...
								<div class="portlet">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-reorder"></i>วันที่.....
										</div>
										<div class="tools">
										...
										<form action="#" class="form-horizontal">
											<div class="form-body">
												<div class="form-group">
													...
													<div class="col-md-12">
													  ...
													  <!--<tr>
														<th colspan="7" scope="col"><center></center></th>
													  </tr>-->
													  <tr>
														<td bgcolor="6699FF" align="center"width="60" height="40">เวลา</td>
														<td bgcolor="6699FF" align="center" width="100" height="40" >ห้องประชุม</td>
														<td bgcolor="6699FF" align="center" width="100" height="40">ชื่อคนจอง</td>
														<td bgcolor="6699FF" align="center" width="120" height="40">ห้วข้อประชุม</td>
														...
														<td bgcolor ="EEEEEE" align="center" width="100" height="40"></td>
														<td bgcolor ="EEEEEE" align="center" width="120" height="40"></td>
											...
											<div class="form-actions fluid">
												<div class="col-md-offset-5 col-md-9">
													<a href="#"><button type="button" class="btn btn-info">จองห้องประชุม</button></a>&nbsp
													<button type="button" class="btn btn-success">ปฎิทิน</button>
												</div>
											</div>
										</form>
										<!-- END FORM-->

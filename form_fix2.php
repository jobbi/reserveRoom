						...
						<div class="tab-content">
								...
								<div class="portlet">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-reorder"></i>รายการแจ้งซ่อม
										</div>
										<div class="tools">
										...
										<form action="#" class="form-horizontal">
											...
											<div class="form-actions fluid">
												<div class="col-md-offset-5 col-md-9">
													<a href="http://localhost:8080/reserve_room/form_fix.php"><button type="button" class="btn btn-info">แจ้งซ่อม</button></a>&nbsp
